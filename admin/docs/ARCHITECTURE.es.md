...
> Los diagramas Mermaid siguientes se renderizan automáticamente en GitHub / GitLab / VS Code. En otros entornos, utilice el [Mermaid Live Editor](https://mermaid.live/).

---

## 1. Arquitectura de topología del sistema
...
## 2. Arquitectura backend por capas
...
## 9. Proceso de negocio de exportación
...
## 11. Enrutamiento de páginas HarmonyOS
...
## 12. Defensa en profundidad (panorama)
