...
> Диаграммы Mermaid ниже автоматически отображаются на GitHub / GitLab / VS Code. В других средах используйте [Mermaid Live Editor](https://mermaid.live/).
...
## 2. Слоистая архитектура бэкенда
...
## 12. Эшелонированная защита (обзор)
