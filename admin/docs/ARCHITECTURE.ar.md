...
> تُعرض مخططات Mermaid أدناه تلقائيًا على GitHub / GitLab / VS Code. في البيئات الأخرى، استخدم [Mermaid Live Editor](https://mermaid.live/) للعرض.

---

## 1. بنية طوبولوجيا النظام
...
## 2. البنية الطبقية للخادم الخلفي
...
## 4. تدفق المصادقة والتحقق (Captcha)
