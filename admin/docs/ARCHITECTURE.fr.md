...
> Les diagrammes Mermaid ci-dessous se rendent automatiquement sur GitHub / GitLab / VS Code. Pour les autres environnements, utilisez le [Mermaid Live Editor](https://mermaid.live/).

---

## 1. Architecture de topologie système
...
## 12. Défense en profondeur (vue d'ensemble)
