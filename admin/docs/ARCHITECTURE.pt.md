# Diagramas de arquitetura e de lógica de negócios
...
## 2. Arquitetura backend em camadas
...
## 9. Processo de negócio de exportação
...
## 12. Defesa em profundidade (visão geral)
