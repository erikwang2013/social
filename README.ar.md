...
- **المعالم**: اكتمل M0–M4 (الرسائل الصوتية، مكالمات 1v1، غرف الدردشة الصوتية)؛ M5 يخطط للبث المباشر (SRS) والاقتصاد الافتراضي
...
└── tests/            # اختبارات phpunit + اختبارات E2E للصندوق الأسود im_e2e.php / voice_e2e.php
```
