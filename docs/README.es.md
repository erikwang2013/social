...
- **Hitos**: M0–M4 entregados (mensajes de voz, llamadas 1v1, salas de voz); M5 planea streaming en vivo (SRS) y economía virtual
...
└── tests/            # Pruebas unitarias phpunit + E2E de caja negra im_e2e.php / voice_e2e.php
```
