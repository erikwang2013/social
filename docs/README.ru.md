...
**Geist** · сова в наушниках. Днём она следит за лентой (посты / сообщество), ночью — за стримами и голосовыми комнатами, звуковые полосы на груди — сигнал «в сети» (IM), а монета под лапами — виртуальная экономика.
