...
**Geist** · بومة ترتدي سماعات. تحرس الخلاصة (المنشورات / المجتمع) نهارًا، وترافق البث المباشر والغرف الصوتية ليلًا؛ وأشرطة الصوت على صدرها إشارة «متصل» (المراسلة الفورية)، والعملة تحت مخالبها هي اقتصادها الافتراضي.
