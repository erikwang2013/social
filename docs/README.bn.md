...
- **মাইলস্টোন**: M0–M4 ডেলিভারি সম্পন্ন (ভয়েস মেসেজ, 1v1 কল, ভয়েস চ্যাট রুম); M5-এ লাইভ স্ট্রিমিং (SRS) এবং ভার্চুয়াল ইকোনমির পরিকল্পনা
...
└── tests/            # phpunit ইউনিট টেস্ট + im_e2e.php / voice_e2e.php ব্ল্যাক-বক্স E2E
```
