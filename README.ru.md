...
- **Вехи**: M0–M4 сданы (голосовые сообщения, звонки 1v1, голосовые комнаты); M5 — стриминг (SRS) и виртуальная экономика
...
└── tests/            # phpunit-тесты + чёрный ящик E2E: im_e2e.php / voice_e2e.php
```
